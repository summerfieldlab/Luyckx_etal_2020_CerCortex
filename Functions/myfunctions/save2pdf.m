function [] = save2pdf(fighandle,figpath,figtitle,varargin)
%function [] = save2pdf(fighandle,figpath,figtitle,sz)
% Save figure in pdf format.
%
% fighandel = figure handle
...
% Save figure
print(fighandle,'-dpdf','-r300',fullpath);

disp(' ');
disp([figtitle ' saved succesfully.']);
