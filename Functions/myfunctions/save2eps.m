function [] = save2eps(fighandle,figpath,figtitle,varargin)
%function [] = save2eps(fighandle,figpath,figtitle,sz)
...
% Save figure
print(fighandle,'-depsc','-r300',fullpath);

disp(' ');
disp([figtitle '.eps saved succesfully.']);
