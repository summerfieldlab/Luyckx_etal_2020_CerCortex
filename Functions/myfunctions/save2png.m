function [] = save2png(fighandle,figpath,figtitle,varargin)
%function [] = save2png(fighandle,figpath,figtitle,sz)
...
% Save figure
print(fighandle,'-dpng','-r300',fullpath);

disp(' ');
disp([figtitle '.png saved succesfully.']);
